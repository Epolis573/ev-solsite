...
import {
  i as St
} from "./cloud_02.dbe4073e.js";
import {
  i as Hi,
  e as K,
  B as ae,
  g as le
} from "./easing.ca1274dc.js";
import {
  i as Ki,
  t as Be,
  I as Vi
...
import {
  ...
  t as ds,
  N as us
} from "./News.a206a14d.js";
import {
  i as yt
} from "./image.63ed914f.js";
import {
  i as Et,
  a as Lt,
  c as Pt,
...
import {
  ...
  n as $,
  a as _
} from "./project.49f9dddf.js";
import {
  s as He
} from "./spark.83ebcaee.js";
var ht = function() {
  var o = 0,
...
class Ns extends _t {
  ...
  camera;
  camera2D;
  lookAt = T.camera.lookAt.clone();
  cameraPosition = T.camera.position.clone();
  folder;
  street = new G;
  streetHasNotLine = new G;
  cars = [];
  carMixers = [];
  carRunMixer;
  postprocessing = {
  ...
  resize(t, e, s) {
      ...
      this.meshInsideCar?.position.set((t - i) * .47, -(e - n) / 2, 0), this.meshInsideCar?.scale.set(i, n, 1), this.meshTitle.position.copy(T.title.position), this.meshTitle.position.multiplyScalar(r.variableSizeRate);
...
class Ps extends _t {
  ...
  camera;
  camera2D;
  lookAt = h.camera.lookAt.clone();
  cameraPosition = h.camera.position.clone();
  folder;
  street = new G;
  cars = [];
  postprocessing = {
  ...
  uniformsSparks = [];
  isRunTransition = !1;
  isRunTransitionNext = !1;
  isRunTitle = !1;
  isRunText = !1;
  isRunBirdsEyeTransition = !1;
  birdProgress = 0;
  isTransitionedNext = !1;
  isStartAnimation = !1;
  onInit() {
  ...
  resize(t, e, s) {
      ...
      const i = (this.isSp ? 1e3 : W.width) * r.variableSizeRate,
          n = i / W.width * W.height;
      this.meshInsideCar?.position.set((t - i) * .47, -(e - n) / 2, 0), this.meshInsideCar?.scale.set(i, n, 1), this.meshTitle.position.copy(h.title.position), this.meshTitle.position.multiplyScalar(r.variableSizeRate), this.meshTitle.scale.set((this.isSp ? 425 * .5 : It.width) * r.variableSizeRate, (this.isSp ? 91 * .5 : It.height) * r.variableSizeRate, 1)
  }
  progressSpark(t) {
      const e = t;
...
class As extends _t {
  ...
  sceneCar = new U;
  camera;
  lookAt = v.camera.lookAt.clone();
  matrixCamera = new O;
  cameraPosition = v.camera.position.clone();
  cameraRotationZ = v.camera.rotation.z;
  folder;
  street = new G;
  cars = [];
  postprocessing = {
...
(class extends xi {
  ...
  lerp = Us;
  animatedScroll = ut[`TOP_TRANSITION_${mt}_POSITION_END`];
  targetScroll = 0;
  positionValue = 0;
  fromPosition = 0;
  toPosition = this.animatedScroll;
  velocity = 0;
  deltaY = 0;
  timeScaleFooter = 1;
  direction = 0;
  ...
  isRunScroll = !1;
  isFooter = !1;
  startPositionNext = ut[`TOP_TRANSITION_${mt}_POSITION_START`];
  endPositionNext = ut[`TOP_TRANSITION_${mt}_POSITION_END`];
  distanceNext = ut[`TOP_TRANSITION_${mt}_DISTANCE`];
  isRunTransition = !1;
  stats;
  isBlurWindow = !1;
  isInit = !1;
  ...
  transitionType = "kv";
  renderTargetCount = 0;
  sceneMotionBlur = new Z;
  sceneCopy = new Z;
  renderTargets;
  renderTargetNext;
  uniforms;
  motionBlurUniformsWithoutValue;
  uniformsKv;
  uniformsSky;
  isTransitionNext = !1;
  isTransitionStartBack = !1;
  isChangeSection = !1;
  isNight = r.isNightMode;
  isToKv = !1;
  onInit() {
      if (super.onInit({
              autoClear: !1,
  ...
  initGl() {
      ...
      this.emitSelfResize(), ft || (this.glKv = Me.create(o, {
          ...
          if (!(!t && this.nextScene === "AboutBirdsEye" || t && this.nextScene === "About"))
              if (this.startPositionNext = st, this.endPositionNext = dt, this.distanceNext = Le, this.isChangeSection = !1, t) this.uniforms.uProgress.value = 1;
              else {
  ...
  startLoading() {
      r.pageId !== "pageTop" || this.nextScene !== "Kv" || this.glNext?.startLoading()
  }
  onLoadProgress(o) {
      r.pageId !== "pageTop" || this.nextScene !== "Kv" || this.glNext?.progressLoading(o)
  }
  onLoadDone() {
      ...
      }), this.isRunScroll = !0, this.scroll(!0)) : this.glNext?.skipLoading(), this.glNext?.showOnInit && this.glNext?.showOnInit(), this.glNext?.start && this.glNext?.start(), this.glNext?.showComplete && this.glNext.showComplete()) : gsap.delayedCall(.2, () => {
          this.glNext?.loadDone(), this.isNight || Ss()
      }))
  }
  onResize() {
      super.onResize();
      const o = this.width * this.pixelRatio,
          t = this.height * this.pixelRatio;
      this.postprocessing?.camera?.resize(this.width, this.height), this.postprocessing.mesh?.scale.set(this.width, this.height, 1), this.postprocessingKv?.camera?.resize(this.width, this.height), this.postprocessingKv.mesh?.scale.set(this.width, this.height, 1), this.postprocessingSky?.camera?.resize(this.width, this.height), this.postprocessingSky.mesh?.scale.set(this.width, this.height, 1), this.renderTargets?.setSize(o, t), this.renderTargetNext?.setSize(o, t), this.renderTargetKv?.setSize(o, t), this.renderTargetNextKv?.setSize(o, t), this.renderTargetSky?.setSize(o, t), this.renderTargetNextSky?.setSize(o, t), this.motionBlurUniformsWithoutValue?.uResolutionObject.value.set(o, t), this.uniformsKv?.uResolutionObject.value.set(o, t), this.uniformsSky?.uResolutionObject.value.set(o, t), this.gl?.resize(this.width, this.height, this.pixelRatio), this.glNext?.resize(this.width, this.height, this.pixelRatio)
  }
  onTick(o, t, e) {
      if (!this.isBlurWindow) {
          if (this.stats?.begin(), this.time = o % 1e3, this.deltaTime = t, this.frame = e % 1e3, this.isRunningScroll) {
              let s = !1;
              if (!this.duration && this.lerp) this.positionValue = Dt(this.positionValue, this.toPosition, this.lerp), Math.round(this.positionValue) === this.toPosition && (this.positionValue = this.toPosition, s = !0), this.storedDeltaY = Dt(this.storedDeltaY, 0, this.lerp);
              else {
  ...
  scroll(o = !1) {
      ...
      if (this.gl?.scroll && this.gl.scroll(this.animatedScroll, this.deltaY, o), this.glNext?.scroll && this.glNext.scroll(this.animatedScroll, this.deltaY, o), this.animatedScroll >= this.endPositionNext || this.isToKv && this.animatedScroll === 0) this.isRunTransition && (this.isRunTransition = !1, this.isTransitionNext = !1, this.isChangeSection = !1, this.isToKv = !1, this.uniforms.uProgress.value = 1, this.glNext?.showComplete && this.glNext.showComplete(), this.disposeGl(this.nextScene));
      else if (this.startPositionNext < this.animatedScroll && this.animatedScroll < this.endPositionNext) {
          ...
          if (!this.isRunTransition) {
              ...
              if (this.isTransitionNext = this.isTransitionStartBack = i, !e)
                  if (i && !this.gl) {
                      ...
                      }, n)), this.gl?.resize(this.width, this.height, this.pixelRatio), this.gl.restore && this.gl.restore(), this.gl.start && this.gl.start(!0), this.gl.tick(this.time, this.deltaTime, this.frame), this.gl.render(this.transitionType === "skyUp" ? this.renderTargetSky : this.renderTargets)
          ...
          !this.isTransitionNext && s > .5 ? (this.isTransitionNext = !0, this.uniforms.uIsNext && (this.uniforms.uIsNext.value = !0), this.isTransitionStartBack ? (this.isChangeSection && (this.component.show(), this.componentNext.hide()), this.gl?.show && this.gl?.show(), !e && this.glNext?.hide && this.glNext?.hide()) : (this.isChangeSection && (this.component.hide(), this.componentNext.show()), this.gl?.hide && this.gl?.hide(), !e && this.glNext?.show && this.glNext?.show()), this.isKvNext || (this.glNext.tick(this.time, this.deltaTime, this.frame), this.glNext.render(this.transitionType === "skyUp" ? this.renderTargetNextSky : this.renderTargetNext))) : this.isTransitionNext && s <= .5 && (this.isTransitionNext = !1, this.uniforms.uIsNext && (this.uniforms.uIsNext.value = !1), this.isTransitionStartBack ? (this.isChangeSection && (this.component.hide(!0), this.componentNext.show(!0)), this.gl?.show && this.gl?.show(!0), this.glNext?.hide && this.glNext?.hide(!0)) : (this.isChangeSection && (this.component.show(!0), this.componentNext.hide(!0)), this.gl?.hide && this.gl?.hide(!0), this.glNext?.show && this.glNext?.show(!0)), this.isKvNext || (this.gl?.tick(this.time, this.deltaTime, this.frame), this.gl?.render(this.transitionType === "skyUp" ? this.renderTargetSky : this.renderTargets))), this.updateTransition(s)
          ...
          this.gl?.showComplete && this.gl.showComplete(e), e && this.disposeGl(this.nextScene, !0)
      }
      ...
      this.HeaderEnergy?.scroll(t)
  }
  updateTransition(o) {
      this.uniforms.uProgress.value = this.nextScene === "Intro" ? Math.max(o - .7, 0) / (1 - .7) : this.nextScene === "IntroCharging" ? Math.max(o - .22, 0) / (1 - .22) : o, this.gl?.makeTransitionOut && this.gl?.makeTransitionOut(Math.min(o / Wt, 1)), this.gl?.makeTransitionOutFull && this.gl?.makeTransitionOutFull(o), this.glNext?.makeTransitionIn && this.glNext?.makeTransitionIn(Math.max(o - (1 - Wt), 0) / Wt)
  }
  getTransitionType(o) {
      switch (o) {
          case "Intro":
  ...
  changeScene(o, {
      ...
      }, s)), this.gl?.resize(this.width, this.height, this.pixelRatio), this.gl?.restore && this.gl?.restore());
      ...
      switch (this.glNext = this[`gl${i}`], this.glNext || (this.glNext = this[`gl${i}`] = j[i].create(this.el, {
              ...
              pixelRatio: this.pixelRatio,
              isNight: e
          }, i)), this.glNext?.resize(this.width, this.height, this.pixelRatio), this.glNext?.restore && this.glNext?.restore(), this.isNight = e, this.nextScene) {
          case "Kv":
  ...
  changeGl(o = !1, t = !1) {
      ...
      this.gl = this[`gl${e}`], !t && !this.gl && (this.gl = this[`gl${e}`] = j[e].create(this.el, {
          ...
          height: this.height,
          pixelRatio: this.pixelRatio
      }, e), this.gl?.resize(this.width, this.height, this.pixelRatio), this.gl.restore && this.gl.restore(), this.gl.start && this.gl.start(o), this.gl.tick(this.time, this.deltaTime, this.frame), this.gl.render(this.transitionType === "kv" ? this.renderTargetKv : this.transitionType === "skyUp" ? this.renderTargetSky : this.renderTargets))
  }
  changeNextGl(o = !1) {
      ...
      this.glNext = this[`gl${t}`], this.glNext || (this.glNext = this[`gl${t}`] = j[t].create(this.el, {
          ...
          height: this.height,
          pixelRatio: this.pixelRatio
      }, t), this.glNext?.resize(this.width, this.height, this.pixelRatio), this.glNext.restore && this.glNext.restore(), this.glNext.start && this.glNext.start(o), this.glNext.tick(this.time, this.deltaTime, this.frame), this.glNext.render(this.transitionType === "kv" ? this.renderTargetKv : this.transitionType === "skyUp" ? this.renderTargetSky : this.renderTargets))
  }
  disposeGl(o, t = !1) {
...
(class extends ri {
  static componentName = "ButtonTop";
  onInit() {
